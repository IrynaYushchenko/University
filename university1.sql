...
-- Started on 2019-04-15 13:32:41
...
--
-- TOC entry 2823 (class 0 OID 16470)
-- Dependencies: 198
...
--
-- TOC entry 2822 (class 0 OID 16458)
-- Dependencies: 197
...
--
-- TOC entry 2821 (class 0 OID 16452)
-- Dependencies: 196
-- Data for Name: subject; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.subject (subject_id, subject, feculty_id, term, hours, test, lecturer_id) VALUES (1, 'biology', 1, 1, 16, 'exam', 3);
INSERT INTO public.subject (subject_id, subject, feculty_id, term, hours, test, lecturer_id) VALUES (2, 'agronomics', 1, 2, 16, 'test', 3);
INSERT INTO public.subject (subject_id, subject, feculty_id, term, hours, test, lecturer_id) VALUES (3, 'physics', 2, 2, 32, 'exam', 1);
INSERT INTO public.subject (subject_id, subject, feculty_id, term, hours, test, lecturer_id) VALUES (4, 'law', 3, 1, 16, 'exam', 4);


--
-- TOC entry 2699 (class 2606 OID 16479)
...
--
-- TOC entry 2695 (class 2606 OID 16489)
...
-- Completed on 2019-04-15 13:32:41
